    ...
    <div id="work-content">
        ...
        <div class="work-content-right">
            <div class="cloud-container">
                <img class="cloud nudge" title="Cloud"
                    src="http://localhost/mansytivity/wp-content/uploads/2020/02/cloud-image.svg" />
            </div>
            <div class="cloud-container">
                <img class="cloud nudge2" title="Cloud"
                    src="http://localhost/mansytivity/wp-content/uploads/2020/02/cloud-image.svg" />
            </div>
            <div class="avatar-work-container"><img class="avatar-work" title="Work Avatar"
                    src="http://localhost/mansytivity/wp-content/uploads/2020/02/work-avatar.svg" />
            </div>
